...
(
    ...
    BK_TITLE VARCHAR(150) NOT NULL,
    BK_AUTHOR VARCHAR(150) NOT NULL,
	BK_PUBLISHER VARCHAR(300) NOT NULL,
    ...
    CONSTRAINT BK_FK FOREIGN KEY (US_ID) REFERENCES IG_USERS (US_ID),
    UNIQUE KEY BK_CK (BK_TITLE, BK_AUTHOR, US_ID)
);
